...
/** 헤더 종 아이콘: 최근 시스템 이벤트 몇 개. 경고·오류가 있으면 빨간 점 */
export function NotificationMenu({ feed }: { feed: FeedItem[] }) {
  ...
  const hasAlert = recent.some((item) => item.tone === "warning" || item.tone === "error");
